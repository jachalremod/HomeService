...
type BusinessProfile = { company_name: string; phone: string | null; email: string | null; license_number: string | null; logo_url: string | null; default_terms: string | null };
...
export default function EstimateForm({ customers, business, initialEstimate }: EstimateFormProps) {
  ...
  const [terms, setTerms] = useState(initialEstimate?.terms ?? business?.default_terms ?? "");
